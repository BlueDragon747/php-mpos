    ...
    {if $PAGE|@count == 0}{assign "PAGE" $smarty.request.page|default:"home"}{else}{assign "PAGE" "home"}{/if}
    {if $ACTION|@count == 0}{assign "ACTION" $smarty.request.action|default:""}{else}{assign "ACTION" ""}{/if}
