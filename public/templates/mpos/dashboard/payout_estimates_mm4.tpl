         ...
         <tr>
           <td colspan="2"><b><u>{$GLOBAL.config.currency_mm4} Estimates</u></b></td>
         </tr>
{if $GLOBAL.config.payout_system_mm4 != 'pps'}
         <tr>
           <td><b>Block</b></td>
           <td id="b-block" class="right">{$GLOBAL.userdata.estimates_mm4.block|number_format:"8"}</td>
         </tr>
         <tr>
           <td><b>Fees</b></td>
           <td id="b-fee" class="right">{$GLOBAL.userdata.estimates_mm4.fee|number_format:"8"}</td>
         </tr>
         <tr>
           <td><b>Donation</b></td>
           <td id="b-donation" class="right">{$GLOBAL.userdata.estimates_mm4.donation|number_format:"8"}</td>
         </tr>
         <tr>
           <td><b>Payout</b></td>
           <td id="b-payout" class="right">{$GLOBAL.userdata.estimates_mm4.payout|number_format:"8"}</td>
         </tr>
{else}
        <tr>
          <td><b>in 1 hour</b></td>
