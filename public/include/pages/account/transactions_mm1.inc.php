...
if ($user->isAuthenticated()) {
  ...
  $aTransactions = $transaction_mm1->getTransactions($start, @$_REQUEST['filter'], $iLimit, $_SESSION['USERDATA']['id']);
  ...
  $aTransactionSummary = !$summary_disabled
    ? $transaction_mm1->getTransactionSummary_mm1($_SESSION['USERDATA']['id'])
    : null;

  $tx_v2_action          = 'transactions_mm1';
  $tx_v2_currency        = isset($config['currency_mm1']) ? $config['currency_mm1'] : '';
