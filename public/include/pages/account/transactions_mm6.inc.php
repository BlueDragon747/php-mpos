...
if ($user->isAuthenticated()) {
  ...
  $aTransactions = $transaction_mm6->getTransactions($start, @$_REQUEST['filter'], $iLimit, $_SESSION['USERDATA']['id']);
  ...
  if (!$setting->getValue('disable_transactionsummary')) {
    $aTransactionSummary_mm6 = $transaction_mm6->getTransactionSummary_mm6($_SESSION['USERDATA']['id']);
    $smarty->assign('SUMMARY_MM6', $aTransactionSummary_mm6);
  }
