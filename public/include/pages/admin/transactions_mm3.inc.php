...
if (!$smarty->isCached('master.tpl', $smarty_cache_key)) {
  ...
  $aTransactions = $transaction_mm3->getTransactions($start, @$_REQUEST['filter'], $iLimit);
  ...
  $aTransactionSummary = !$summary_disabled
    ? $transaction_mm3->getTransactionSummary_mm3()
    : null;

  $tx_v2_action          = 'transactions_mm3';
  $tx_v2_page            = 'admin';
  $tx_v2_show_username   = true;
  $tx_v2_currency        = isset($config['currency_mm3']) ? $config['currency_mm3'] : '';
