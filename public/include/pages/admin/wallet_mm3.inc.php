...
if (!$smarty->isCached('master.tpl', $smarty_cache_key)) {
  ...
  empty($config['network_confirmations_mm3']) ? $confirmations = 120 : $confirmations = $config['network_confirmations_mm3'];
  ...
  $smarty->assign("COIN_RULE_STATUS", bsx_daemon_rule_status($bitcoin_mm3, $aGetInfo_mm3, null, null, $wallet_ticker));
