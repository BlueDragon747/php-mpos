...
class Statistics_mm6 extends Base {
  ...
  public function getNetworkExpectedTimePerBlock_mm6(){
    ...
    if($dNetworkHashrate <= 0){
      return $this->memcache->setCache(__FUNCTION__, $this->config['cointarget_mm6']);
    }
  ...
  public function getExpectedNextDifficulty_mm6(){
    ...
    return $this->memcache->setCache(__FUNCTION__, round($dDifficulty * $this->config['cointarget_mm6'] / $this->getNetworkExpectedTimePerBlock_mm6(), 8));
  }
