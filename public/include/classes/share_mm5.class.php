...
class Share_mm5 Extends Base {
  protected $table = 'shares_mm5';
  protected $tableArchive = 'shares_archive_mm5';
  private $oUpstream;
  ...
  public function moveArchive($current_upstream, $block_id, $previous_upstream=0) {
    if ($this->config['payout_system_mm5'] != 'pplns') {
...
$share_mm5 = new Share_mm5();
$share_mm5->setDebug($debug);
$share_mm5->setMysql($mysqli);
$share_mm5->setConfig($config);
$share_mm5->setUser($user);
$share_mm5->setBlock($block_mm5);
$share_mm5->setErrorCodes($aErrorCodes);
