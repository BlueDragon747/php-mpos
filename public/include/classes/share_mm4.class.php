...
class Share_mm4 Extends Base {
  protected $table = 'shares_mm4';
  protected $tableArchive = 'shares_archive_mm4';
  private $oUpstream;
  ...
  public function moveArchive($current_upstream, $block_id, $previous_upstream=0) {
    if ($this->config['payout_system_mm4'] != 'pplns') {
...
$share_mm4 = new Share_mm4();
$share_mm4->setDebug($debug);
$share_mm4->setMysql($mysqli);
$share_mm4->setConfig($config);
$share_mm4->setUser($user);
$share_mm4->setBlock($block_mm4);
$share_mm4->setErrorCodes($aErrorCodes);
