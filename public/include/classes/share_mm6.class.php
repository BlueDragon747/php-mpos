...
class Share_mm6 Extends Base {
  protected $table = 'shares_mm6';
  protected $tableArchive = 'shares_archive_mm6';
  private $oUpstream;
  ...
  public function moveArchive($current_upstream, $block_id, $previous_upstream=0) {
    if ($this->config['payout_system_mm6'] != 'pplns') {
...
$share_mm6 = new Share_mm6();
$share_mm6->setDebug($debug);
$share_mm6->setMysql($mysqli);
$share_mm6->setConfig($config);
$share_mm6->setUser($user);
$share_mm6->setBlock($block_mm6);
$share_mm6->setErrorCodes($aErrorCodes);
