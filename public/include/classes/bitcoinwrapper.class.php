...
$bitcoin_mm = new BitcoinWrapper($config['wallet_mm']['type'], $config['wallet_mm']['username'], $config['wallet_mm']['password'], $config['wallet_mm']['host'], $config['DEBUG'], $debug, $memcache);
