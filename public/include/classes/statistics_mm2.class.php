...
class Statistics_mm2 extends Base {
  ...
  public function getNetworkExpectedTimePerBlock_mm2(){
    ...
    if($dNetworkHashrate <= 0){
      return $this->memcache->setCache(__FUNCTION__, $this->config['cointarget_mm2']);
    }
  ...
  public function getExpectedNextDifficulty_mm2(){
    ...
    return $this->memcache->setCache(__FUNCTION__, round($dDifficulty * $this->config['cointarget_mm2'] / $this->getNetworkExpectedTimePerBlock_mm2(), 8));
  }
