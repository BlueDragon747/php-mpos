...
existing PHP/Smarty UI. See `MPOS-Postsegwit.md` (repo root, 2026-04-26
"Frontend modernization" section) for the full plan.
...
Document the reason in `MPOS-Postsegwit.md` if we make the swap.
...
5. Follow the per-page workflow in `MPOS-Postsegwit.md`:
